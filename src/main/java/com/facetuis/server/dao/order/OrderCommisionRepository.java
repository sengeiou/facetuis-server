...
public interface OrderCommisionRepository extends JpaRepository<OrderCommision,String> {
     ...
     * @return
     */
    @Query(value = "select sum(user_commision) from t_order_commision where user_id = ?1 and order_status = ?2 and  order_create_time > ?2  and  order_create_time < ?3 ",nativeQuery = true)
    Long findTeamUserTotalByStatus(String userId,Long status,Long begTime,Long endTime);
     ...
     * @return
     */
    @Query(value = "select sum(user_commision + user1commision + user2commision) from t_order_commision where user3id = ?1 and order_status = ?2 and  order_create_time > ?3  and  order_create_time < ?4 ",nativeQuery = true)
    Long findTeamUser3TotalByStatus(String userId,Long status,Long begTime,Long endTime);
     ...
     * @return
     */
    @Query(value = "select sum(user_commision + user1commision) from t_order_commision where user2id = ?1  and order_status = ?2  and  order_create_time > ?3  and  order_create_time < ?4 ",nativeQuery = true)
    Long findTeamUser2TotalByStatus(String userId,Long status,Long begTime,Long endTime);
     ...
     * @return
     */
    @Query(value = "select sum(user_commision) from t_order_commision where user1id = ?1  and order_status = ?2  and  order_create_time > ?3  and  order_create_time < ?4 ",nativeQuery = true)
    Long findTeamUser1TotalByStatus(String userId ,Long status,Long begTime,Long endTime);
